...
class BookDatabaseHelper(context: Context) :
    ...
    companion object {
        ...
        private const val CREATE_TABLE_BOOKS = """
            ...
            ${DatabaseConstants.BOOK.COLUMNS.ID} INTERGER PRIMARY KEY AUTOINCREMENT,
            ...
            ${DatabaseConstants.BOOK.COLUMNS.FAVORITE} INTERGER NOT NULL
            );
        """
    }
    ...
    private fun insertBooks(db: SQLiteDatabase) {
        ...
        for (book in books) {
            val values = ContentValues().apply {
                put(DatabaseConstants.BOOK.COLUMNS.TITLE, book.tittle)
